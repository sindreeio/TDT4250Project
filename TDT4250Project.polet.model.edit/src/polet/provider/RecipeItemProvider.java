...
/**
 * This is the item provider adapter for a {@link polet.Recipe} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RecipeItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addRecepieIdPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PoletPackage.Literals.RECIPE__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Recepie Id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRecepieIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Recipe_recepieId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Recipe_recepieId_feature", "_UI_Recipe_type"),
				 PoletPackage.Literals.RECIPE__RECEPIE_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMealTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Recipe_mealType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Recipe_mealType_feature", "_UI_Recipe_type"),
				 PoletPackage.Literals.RECIPE__MEAL_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLinkPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Recipe_link_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Recipe_link_feature", "_UI_Recipe_type"),
				 PoletPackage.Literals.RECIPE__LINK,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
