...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Krone Per Volume</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link polet.impl.KronePerVolumeImpl#getDerivedNumber <em>Derived Number</em>}</li>
 *   <li>{@link polet.impl.KronePerVolumeImpl#getProducts <em>Products</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KronePerVolumeImpl extends MinimalEObjectImpl.Container implements KronePerVolume {
	/**
	...
	protected EClass eStaticClass() {
		return PoletPackage.Literals.KRONE_PER_VOLUME;
	}
	...
	public void setDerivedNumber(float newDerivedNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PoletPackage.KRONE_PER_VOLUME__DERIVED_NUMBER, oldDerivedNumber, derivedNumber));
	}
	...
	public EList<Product> getProducts() {
		if (products == null) {
			products = new EObjectWithInverseResolvingEList<Product>(Product.class, this, PoletPackage.KRONE_PER_VOLUME__PRODUCTS, PoletPackage.PRODUCT__KRONE_PER_VOLUME);
		}
		return products;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PoletPackage.KRONE_PER_VOLUME__PRODUCTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PoletPackage.KRONE_PER_VOLUME__DERIVED_NUMBER:
